...
public class B_Switch {
	//switch문의 역할을 if문이 100활용가능하기 때문에 많이 사용하지는 X
	/*
	 * switch문
	 *   - if문과 동일한 조건문
	 ...
	 * 			 break; // 어차피 마지막이라 필요없긴함
	 * }
	 * 
	 * switch의 장점 -> case를 통해 내가 실행하기를 원하는 코드로 즉시 이동하기 때문에
	 * 연산속도가 if ~ else if문 보다 빠르다
	 * 
	 * switch문의 사용처
	...
	public void method2() {
		...
		// 동등성비교 vs. 동일성비교
		// switch는 equals()와 같은 방식을 사용하기 떄문에 문제X
		switch(fruit) {
		case "사과" :
			price = 1000;
			break;
